  ...
  return (
    <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 overflow-hidden">
      ...
      <div className="flex items-center gap-2 px-4 h-12 border-b border-zinc-100 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50">
        ...
        <span className="text-sm font-semibold text-zinc-800 dark:text-zinc-200 flex-1">SQL Joins</span>
      ...
      <div className="flex items-center gap-1.5 px-4 py-2.5 border-b border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/20">
        ...
        <span className="ml-auto text-[10px] text-zinc-400 hidden sm:block">{leftTable} ↔ {rightTable}</span>
      </div>
